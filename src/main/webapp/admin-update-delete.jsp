...
<div class="container">
	...
	<div class="title-menor">
            <a href="clients?action=admin-ud" id="linka">Update and Delete</a>
            <a href="clients?action=admincreate">Create</a>
	</div>
	...
	<div class="container-table">
		...
		<table class="table">
  			...
  			<tbody>
				    ...
				    <tr bgcolor="#f9f9f9">
				    <td scope="col"> <c:out value="${client.clientId} "/> </td>
				    ...
				    <td scope="col">
					    ...
					    <a href="?action=delete&clientId=<c:out value="${client.clientId}" />"><i class="fa fa-trash" aria-hidden="true"></i></a>
					    <a href="?action=edit&clientId=<c:out value="${client.clientId}" />"><i class="fa fa-edit" aria-hidden="true"></i></a>
